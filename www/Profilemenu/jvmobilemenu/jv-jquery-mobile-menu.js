...
(function ($) {
  ...
  $.fn.jvmobilemenu = function (options) {
    ...
    $(this).prepend('<div class="hamburger"><div class="hamburger-inner"><div class="bar bar1 cross"></div><div class="bar bar2 cross"></div><div class="bar bar3 cross"></div><div class="bar bar4"></div></div></div>');
